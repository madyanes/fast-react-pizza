      ...
      <Form method='POST'>
        ...
        <div>
          <input
            ...
            className='h-6 w-6 accent-yellow-500 focus-within:ring-offset-2 focus:outline-none focus:ring focus:ring-yellow-400'
          />
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone))
    errors.phone =
      'Please give us your contact number. We might need it to contact you.'
